...
# История общения
chat_history = [
    Messages(role=MessagesRole.SYSTEM, content="ты специалист в медицине, твоя задача давать мне советы по моему здоровью. Если попрошу построить график по показателю, ты построишь график используя функцию make_plot()")
]
'''
